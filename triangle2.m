%% Directed version {1,3,2}, {1,2}, {2,3}, {3,1}
g = 1/3;
...
A1 = [0 0 1; 1 0 0; 0 1 0]; % edge-edge
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle2_v1.jpg','Resolution',300) 
...
sigx_m = exp(-delta*i)*sigx;
sigx_p = exp(delta*i)*sigx;

T =[O sigx_m sigx_p; sigx_p O sigx_m; sigx_m sigx_p O];
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle2_v2.jpg','Resolution',300) 
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle2_v3.jpg','Resolution',300) 
