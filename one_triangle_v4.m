...
edge_name = [23 13 12]'; edge_name = num2str(edge_name); edge_label = cellstr(edge_name);
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle_v4_L0Mu.eps','Resolution',300) 
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle_v4_L1Md.eps','Resolution',300) 
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle_v4_L1Mu.eps','Resolution',300) 
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle_v4_L1M.eps','Resolution',300)  
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle_v4.jpg','Resolution',300) 
