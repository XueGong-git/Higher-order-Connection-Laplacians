...
plot(time_step, angle(abs(xtu(1,:))+ i1*abs(xtu(2,:))))

plot(time_step, angle(xtu(3, :)))
plot(time_step, angle(xtu(4,:)))
plot(time_step, angle(abs(xtu(3,:))+ i1*abs(xtu(4,:))))

plot(time_step, angle(xtu(5, :)))
plot(time_step, angle(xtu(6,:)))
plot(time_step, angle(abs(xtu(5,:))+ i1*abs(xtu(6,:))))
hold off
title('x(t) Up');
xlabel('t')
...
plot(time_step, angle(abs(xtl(1,:))+ i1*abs(xtl(2,:))))

plot(time_step, angle(xtd(3, :)))
plot(time_step, angle(xtd(4,:)))
plot(time_step, angle(abs(xtd(3,:))+ i1*abs(xtd(4,:))))

plot(time_step, angle(xtd(5, :)))
plot(time_step, angle(xtd(6,:)))
plot(time_step, angle(abs(xtd(5,:))+ i1*abs(xtd(6,:))))
hold off
title('x(t) Down');
xlabel('t')
legend('\theta_1','\psi_1','\phi_1','\theta_2','\psi_2', '\phi_2','\theta_3','\psi_3','\phi_3')
...
hold on 
plot(time_step, angle(xtl(2,:)+i1*0.0001))
plot(time_step, angle(abs(xtl(1,:))+ i1*abs(xtl(2,:))))

plot(time_step, angle(xtl(3, :)))
plot(time_step, angle(xtl(4,:)))
plot(time_step, angle(abs(xtl(3,:))+ i1*abs(xtl(4,:))))

plot(time_step, angle(xtl(5, :)))
plot(time_step, angle(xtl(6,:)))
plot(time_step, angle(abs(xtl(5,:))+ i1*abs(xtl(6,:))))
hold off
title('x(t) Up + Down');
xlabel('t')
legend('\theta_1','\psi_1','\phi_1','\theta_2','\psi_2', '\phi_2','\theta_3','\psi_3','\phi_3')
