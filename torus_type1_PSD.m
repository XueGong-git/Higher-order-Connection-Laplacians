...
%L1_down=[2*eye(2),exp(-i1*delta)*eye(2),-sy,exp(-i1*delta)*eye(2),sy,exp(-i1*delta)*eye(2);
%          exp(i1*delta)*eye(2), 2*eye(2), exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), sz;
%          -sy, exp(-i1*delta)*eye(2), 2*eye(2), exp(-i1*delta)*eye(2), sy, exp(-i1*delta)*eye(2);
%          exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), 2*eye(2), exp(i1*delta)*eye(2), sz;
%          sy, exp(-i1*delta)*eye(2), sy, exp(-i1*delta)*eye(2), 2*eye(2), exp(-i1*delta)*eye(2);
%          exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), 2*eye(2)];

A_down=[2*eye(2),1*eye(2),1*eye(2),-1*eye(2), -1*eye(2), -1*eye(2);
          1*eye(2), 2*eye(2), 1*eye(2),-1*eye(2), -1*eye(2), -1*eye(2);
          1*eye(2), 1*eye(2), 2*eye(2),-1*eye(2), -1*eye(2), -1*eye(2) ;
          -1*eye(2), -1*eye(2), -1*eye(2), 2*eye(2), 1*eye(2), 1*eye(2);
         -1*eye(2), -1*eye(2), -1*eye(2),1*eye(2), 2*eye(2), 1*eye(2);
         -1*eye(2), -1*eye(2), -1*eye(2),1*eye(2),1*eye(2), 2*eye(2)];

T_down=[eye(2),exp(-i1*delta)*eye(2),sy,exp(-i1*delta)*eye(2),sy,exp(-i1*delta)*eye(2);
          exp(i1*delta)*eye(2), eye(2),exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), sz;
          sy, exp(-i1*delta)*eye(2), eye(2), exp(-i1*delta)*eye(2), sy, exp(-i1*delta)*eye(2);
          exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), eye(2), exp(i1*delta)*eye(2), sz;
          sy, exp(-i1*delta)*eye(2), sy, exp(-i1*delta)*eye(2), eye(2), exp(-i1*delta)*eye(2);
          exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), sz, exp(i1*delta)*eye(2), eye(2)];
...
if max_step/n == 3
    ...
    saveas(gcf, strcat('plots\torus_type1_eigvec_', num2str(round(coef, 1)), 'pi.png'));
