...
L1_up1=[1, -exp(i1*delta), exp(-i1*delta);
...
L1_up2(1,:)=[1, 0,                0, -exp(-i1*delta),   0, exp(i1*delta)];
L1_up2(2,:)=[0, 1,                -exp(-i1*delta), 0,   exp(i1*delta), 0];

L1_up2(3,:)=[0, -exp(i1*delta),    1,0,                0,-exp(-i1*delta)];
L1_up2(4,:)=[-exp(i1*delta), 0,    0,1,                -exp(-i1*delta),0];

L1_up2(5,:)=[0, exp(-i1*delta),  0,-exp(i1*delta),   1,0];
L1_up2(6,:)=[exp(-i1*delta), 0,  -exp(i1*delta),0,   0,1];
...
if max_step/n == 6
    ...
    title('$\phi_1$ of $L_{[1,up]}^{M}$', 'fontsize', 12, 'Interpreter', 'latex');
    ...
    title('$\phi_2$ of $L_{[1,up]}^{M}$', 'fontsize', 12, 'Interpreter', 'latex');
    colorbar('Ticks',[0,0.25,0.5,0.75, 1],...
             'TickLabels',{'-\pi','-\pi/2','0','\pi/2','\pi'})
    ...
    title('$\phi_1$ of $L_{[1,down]}^{M}$', 'fontsize', 12, 'Interpreter', 'latex');
    colorbar('Ticks',[0,0.25,0.5,0.75, 1],...
             'TickLabels',{'-\pi','-\pi/2','0','\pi/2','\pi'})     
    ...
    title('$\phi_2$ of $L_{[1]}^{M}$', 'fontsize', 12, 'Interpreter', 'latex');
    colorbar('Ticks',[0,0.25,0.5,0.75, 1],...
             'TickLabels',{'-\pi','-\pi/2','0','\pi/2','\pi'}) 
    ...
    title('$\phi_1$ of $L_{[1]}^{M}$', 'fontsize', 12, 'Interpreter', 'latex');
    colorbar('Ticks',[0,0.25,0.5,0.75, 1],...
             'TickLabels',{'-\pi','-\pi/2','0','\pi/2','\pi'})     
    ...
    saveas(gcf, 'plots\torus_type2_eigvec.eps', 'epsc');
    %saveas(gcf, 'plots\torus_type2_eigvec.png');
...
xlabel('\delta')
%ylim([-1 1])
saveas(gcf, 'plots\torus_type2_spectrum.eps', 'eps');
%saveas(gcf, 'plots\torus_type2_spectrum.png');
