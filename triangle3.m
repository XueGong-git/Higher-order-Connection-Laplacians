...
A0 = [0 1 1; 0 0 1; 0 0 0]; % node-node
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle3_v1.jpg','Resolution',300) 
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle3_v2.jpg','Resolution',300) 
...
plt.LineWidth = 2;
ax = gca;
exportgraphics(ax,'plots/triangle3_v3.jpg','Resolution',300) 
