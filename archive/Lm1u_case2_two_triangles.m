%  4 nodes {1}, {2}, {3}, {4}
%  3 edges {1,2}, {1,3}, {2,3}, {4,3}, {4,2}
%  1 triangle {1,2,3}, {2,3,4}
% create boundary operators
%%% B1
B1 = [-1 -1 0 0 0 ; 1 0 -1 0 1; 0 1 1 1 0; 0 0 0 -1 -1];
...
T =[I2 Ip Im I2 I2; Im I2 Ip I2 I2; Ip Im I2 Im Ip; I2 I2 Ip I2 Im; I2 I2 Im Ip I2];
...
scatter(1:10, angle(Vm1u(:,1)))


Lm1u_small = Lm1u(1:2:end, 1:2:end);
[V,D] = eig(Lm1u_small); % zero eigenvalues find connected components of edges through shared triangles
scatter(1:5, angle(V(:,1)))
