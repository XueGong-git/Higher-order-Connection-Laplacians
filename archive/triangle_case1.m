...
hold off
title('Spectrum of $\bar{L_{1}}^{M, up}$', 'Interpreter', 'latex');
...
hold off
title('Spectrum of $\bar{L_{1}}^{M, down}$', 'Interpreter', 'latex');
xticks([0 pi/2 pi 3*pi/2 2*pi])
xticklabels({'$0$', '$\pi/2$', '$\pi$', '$3\pi/2$', '$2\pi$'})
ylim([-0.1 4.1])
% Add a label to the x-axis
...
hold off
title('Spectrum of $\bar{L_{1}}^{M}$', 'Interpreter', 'latex');
xticks([0 pi/2 pi 3*pi/2 2*pi])
xticklabels({'$0$', '$\pi/2$', '$\pi$', '$3\pi/2$', '$2\pi$'})
% Add a label to the x-axis
xlabel('\delta')
...
%% compare with constructMagneticLaplacian function
